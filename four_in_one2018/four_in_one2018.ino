...
char val; 
//***********************設定所偵測到的IRcode*************************
long IRfront= 0x00FD8877;        //前進碼
long IRback=0x00FD9867;         //後退
long IRturnright=0x00FD6897;    //右轉
long IRturnleft= 0x00FD28D7;     //左轉
long IRstop=0x00FDA857;         //停止
long IRcny70=0x00FD7080;        //CNY70自走模式 0x00FD708F
long IRAutorun=0x00FD30CF;      //超音波自走模式
long IRturnsmallleft= 0x00FDB04F; 
//*************************定義CNY70腳位************************************
...
{ 
   ...
   {
analogWrite(LED_BUILTIN, 1024/Fspeedd);
      stopp(1); // 清除輸出資料 
      ask_pin_L(); // 讀取左方距離
...
//==========================================================================               
             ...
             { 
              ...
              //break;
                ...
                results.value=0;
                advance(1); // 正常前進 
                //Serial.println(" Advance "); //顯示方向(前進)
                //Serial.print(" "); 
            }
